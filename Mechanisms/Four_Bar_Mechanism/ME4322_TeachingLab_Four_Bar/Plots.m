...
load('Kin/LinVel/Link/BCE')
load('Kin/LinVel/Link/CD')
...
plotKinematicData([timestep, V_bce_com], 3, [3, 2], 2, 'Velocity of Link BCE', 'x', 'Velocity', 'g');
plotKinematicData([timestep, V_cd_com], 3, [3, 2], 3, 'Velocity of Link CD', 'x', 'Velocity', 'b');
...
plotKinematicData([timestep, A_bce_com], 4, [3, 2], 2, 'Acceleration of Link BCE', 'x', 'Acceleration', 'g');
plotKinematicData([timestep, A_cd_com], 4, [3, 2], 3, 'Acceleration of Link CD', 'x', 'Acceleration', 'b');
