...
Mechanism.Angle.ABEH(iteration, :) = [0,0,rad2deg(atan2(Mechanism.LinkCoM.ABEH(iteration,2) - A(2), Mechanism.LinkCoM.ABEH(iteration,1) - A(1)))];
Mechanism.Angle.BCFG(iteration, :) = [0,0,rad2deg(atan2(Mechanism.LinkCoM.BCFG(iteration,2) - B(2), Mechanism.LinkCoM.BCFG(iteration,1) - B(1)))];
Mechanism.Angle.CDI(iteration, :) = [0,0,rad2deg(atan2(Mechanism.LinkCoM.CDI(iteration,2) - C(2), Mechanism.LinkCoM.CDI(iteration,1) - C(1)))];
